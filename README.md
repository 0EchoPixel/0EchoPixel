...
I prefer Linux over Windows, but most of the software I use just runs better on Windows. 😢 (BTW, check out my [Windows optimization guide](https://github.com/0EchoPixel/WindowsOptimizationGuide))</b> <br>  
